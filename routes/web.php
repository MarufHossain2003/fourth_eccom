...
Route::get('/shop',                                         [HomeController::class, 'shopProducts'])->name('shop');
Route::get('/return-process',                               [HomeController::class, 'returnProducts'])->name('return-process');
...
Route::get('sub-category-products/{slug}',                  [HomeController::class, 'subCategoryProducts'])->name('subcategory.products');
