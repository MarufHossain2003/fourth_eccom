            ...
            <form action="{{ url('/admin/product/update/' . $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sku_code" value="{{ $product->sku_code }}"
                            name="sku_code" placeholder="Enter SKU Code" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="sub_cat_id" id="sub_cat_id" class="form-control">
                            ...
                            @foreach ($subCategories as $subCategory)
                                <option value="{{ $subCategory->id }}" @if ($product->sub_cat_id == $subCategory->id) selected @endif>
                    ...
                    <div class="form-group" id="color_fields">
                        ...
                        @foreach ($product->color as $name)
                            <div class="input-group mt-3 color-group">
                                <input type="text" class="form-control" id="color" value="{{ $name->color_name }}" name="color[]" placeholder="Enter Product Color">
                    ...
                    <div class="form-group" id="size_fields">
                        ...
                        @foreach ($product->size as $name)
                            <div class="input-group mt-3 size-group">
                               <input type="text" class="form-control" id="size" value="{{ $name->size_name }}" name="size[]" placeholder="Enter Product Size">
                            <div class="input-group-append">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('backend/images/product/' . $product->image) }}" alt=""
                            class="img-fluid mt-3" style="width: 200px; height: 200px;">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="galleryImage" multiple
                                    name="galleryImage[]" accept="image/*">
                                <label class="custom-file-label" for="image">Choose file</label>
                            </div>
                        </div>
